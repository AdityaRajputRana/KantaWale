...
public class UpiPaymentsHelper {
    FirebaseUser user;
    UserRP mUser;

    ArrayList<String> installedUPIAppsList;
    ...
    private UpiPaymentsHelper.Listener listener;
    ...
    private static UpiPaymentsHelper UpiPaymentsHelperInstance;

    public static UpiPaymentsHelper getInstance(){
        return UpiPaymentsHelperInstance;
    }

    private UpiPaymentsHelper(Context context, Activity activity, UpiPaymentsHelper.Listener listener){
        ...
        this.installedUPIAppsList = getInstalledUPIApps();
        Checkout.preload(context);
    }

    public static UpiPaymentsHelper newInstance(Context context, Activity activity, UpiPaymentsHelper.Listener listener){
        UpiPaymentsHelperInstance = new UpiPaymentsHelper(context, activity, listener);
